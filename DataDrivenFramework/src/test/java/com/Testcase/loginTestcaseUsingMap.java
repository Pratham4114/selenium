...
public class loginTestcaseUsingMap extends baseTest
{
	...
	public Object[][] getData() throws Exception
	{
		//String filepath = prop.readfile("excelFilePath");
		   //File file = new File("E://Prathamesh//DataDrivenFramework//loginData.xlsx");
		    FileInputStream fis = new FileInputStream("E://Prathamesh//DataDrivenFramework//loginData.xlsx");
